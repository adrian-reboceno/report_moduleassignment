...
$string['pluginname'] = 'Report module assignment';
$string['moduleassignment:view'] = 'View module assignment report';
$string['configteachersession'] = 'Tracking module assignment';
$string['categoryname'] = 'Module reports';
$string['inactive'] = 'Inactive';
$string['active'] = 'Active';
$string['veryactive'] = 'Very active';
$string['activity'] = 'Activity';
$string['daysinactivity'] = 'days of inactivity';
$string['courseid'] = 'Course id';
$string['courseaccesslast'] = 'Course Access Last';
$string['id'] = 'User ID';
$string['backtofilters'] = 'Back to filters';;
$string['namesection'] = 'Name section';
$string['typemodule'] = 'Type module';
$string['moduloname'] = 'Name module';
$string['start'] = 'Start';
$string['end'] = 'End';
